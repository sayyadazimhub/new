...
import { Plus, Pencil, Trash2, Search, Eye, Filter, Users, Phone, MapPin } from 'lucide-react';
                    ...
                    <tr>
                      <td colSpan={4} className="p-20 text-center">
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <p className="text-slate-400 font-medium text-lg">No providers found in registry</p>
